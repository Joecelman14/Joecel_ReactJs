      ...
      <section className="contact section" id="contact">
        <div className="container">
          ...
          <div className="row">
            ...
            <a href="mail to: joecelmandaguit@gmail.com" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faEnvelope} size="2x" className="icon" />
              </a>
              <h4>Email me at</h4>
              <p>joecelmandaguit@gmail.com</p>
            </div>
            <div className="contact-info-item padd-15">
            <a href="https://facebook.com/Joecel T. Mandaguit" target="_blank" rel="noopener noreferrer">
            ...
            <div className="contact-info-item padd-15">
            <a href="https://github.com/joecelman14" target="_blank" rel="noopener noreferrer">
