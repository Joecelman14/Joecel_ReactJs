...
import Joecel from "../img/Joecel.png";
                  ...
                  <div className="col-lg-6 ok">
                    <div className="card">
                      ...
                      <p className="self text-light">
                        I'm a Digital Artist & Multimedia Designer
                      </p>
    ...
    <div className="row">
      <div className="col-lg-4 mb-3">
        <div className="card p-5 shadow text-center">
          <img src={h4} className="card-img-top mt-3" alt="" />
        </div>
      </div>
      <div className="col-lg-4 mb-3">
        <div className="card p-5 shadow text-center">
          <img src={h2} className="card-img-top mt-3" alt="" />
        </div>
      </div>
      <div className="col-lg-4 mb-3">
        <div className="card p-5 shadow text-center">
          <img src={h3} className="card-img-top mt-3" alt="" />
        </div>
      </div>
    </div>
  </div>
