            ...
            <div className="card p-5 shadow">
              <div className="row">
                <div className="col-lg-7 text">
                  ...
                  <p>
                    Im Joecel Mandaguit, and I am 22 years old. I am currently a BSIT student at Central Philippine State University,
            ...
            <div class="row">
                ...
                <div class="single-horizontal-timeline">
                  ...
                  <div class="timeline text-center">
                    <div class="timeline-content">
                      ...
                      <p className="text-secondary">
                        Barangay 8, Kabankalan City, Negros Occidental
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 text-center mb-3">
                <div class="single-horizontal-timeline">
                  ...
                  <div class="timeline text-center">
                    <div class="timeline-content">
                      <h4 class="title">D.C Gurrucharri Memorial School</h4>
                      <p className="text-secondary">
                        Overflow, Kabankalan City, Negros Occidental
                      </p>
                    </div>
                  </div>
                </div>
